  ...
  return(
    <div className="min-h-screen w-full bg-[#F5E6E2]">
      ...
      <section className="px-6 min-h-screen w-full flex flex-col gap-4 md:px-16 md:gap-8 -mt-56">
          <span ref={ref} className="opacity-0 font-dm text-xs text-[#3d2c2c]/20 md:text-lg tracking-widest">&mdash; About us</span>
          <h4 ref={ref1} className="opacity-0 font-cormorant text-4xl md:text-6xl text-[#3d2c2c]/70">Our Story</h4>
          <p ref={ref2} className="opacity-0 font-dm font-light text-[#7a5c58]/70 tracking-wide leading-24">
      ...
      <section className="px-6 min-h-screen w-full flex flex-col gap-4 md:px-16 md:gap-8 -mt-80">
          <span ref={ref3} className="opacity-0 font-dm text-xs text-[#3d2c2c]/20 md:text-lg tracking-widest">&mdash; Contact</span>
          <h5 ref={ref4} className="opacity-0 font-cormorant text-4xl text-[#3d2c2c]/70 md:text-6xl">Get in Touch</h5>
          <p ref={ref5} className="opacity-0 font-dm font-light text-[#7a5c58]/70 tracking-wide leading-16">
